                    ...
                    <tbody>
                        @forelse ($customers as $customer)
                            <tr>
                                ...
                                <td scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ Storage::url($customer->picture) }}"
                                            style="max-width:3rem;min-height:3rem;"
                                            style="max-width: 45px; min-height: 45px" class="rounded-circle">
                                        {{-- <div class="ms-3">
                                    <p class="fw-bold mb-1">{{ $customer->first_name }}{{ ' ' }}{{ $customer->middle_name }}{{ ' ' }}{{ $customer->last_name }}</p>
                                ...
                                <td>
                                    <p class="fw-normal mb-1">{{ $customer->sex }}</p>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-warning btn-sm me-3" data-bs-toggle="modal"
