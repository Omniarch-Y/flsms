                    ...
                    <table class="table align-middle mb-0 bg-white">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td scope="row"><img src="{{ Storage::url($customer->picture) }}" style="max-width:3rem;min-height:3rem;" style="max-width: 45px; min-height: 45px"></td>
                              ...
                              <td>
                                  ...
                                  <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteCustomer" wire:click='deleteCustomer({{ $customer->id}})'>Delete</button>
                                  @include('livewire.customer.delete')
                                  <button type="button" class="btn btn-success btn-sm" wire:click='issueLoan({{ $customer->id}})'>Loan</button>
