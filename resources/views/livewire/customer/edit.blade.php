                            ...
                            <div class="row g-4 mb-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input id="middle_name" type="text"
                                        ...
                                        name="middle_name" placeholder="{{ __('Enter middle name') }}"
                                        autocomplete="middle_name" autofocus wire:model.debounce.500ms="middle_name">
                                    ...
                                    <div class="row ms-1">
                                        <div class="form-check col-sm-3">
                                            ...
                                            <input class="form-check-input" type="radio" name="sex" id="sex"
                                                value="{{ 'F' }}" wire:model.debounce.500ms="sex"
                                                required>
                                            <label class="form-check-label" for="sex">Female</label>
                                        </div>
                                        <div class="form-check col-sm-3">
                                            <input class="form-check-input" type="radio" name="sex" id="sex"
                                                value="{{ 'M' }}" wire:model.debounce.500ms="sex"
                                                required>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input id="phone_number" placeholder="{{ __('Enter phone number') }}"
                                        type="number" class="form-control @error('phone_number') is-invalid @enderror"
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input id="business_type" type="text"
                                        ...
                                        autocomplete="business_type" autofocus
                                        wire:model.debounce.500ms="business_type">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input id="group_name" type="text"
                                        ...
                                        name="group_name" placeholder="{{ __('Enter group name') }}"
                                        autocomplete="group_name" autofocus wire:model.debounce.500ms="group_name">
