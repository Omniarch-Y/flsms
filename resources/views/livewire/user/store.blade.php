...
<div wire:ignore.self class="modal fade" id="registerUser" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
       <div class="modal-content">
             <div class="modal-header justify-content-center">
                <center>
                    <h2 class="modal-title text-dark text-center "style=" justify-content-center">{{ __('User registration') }}</h2>
                </center>
                      ...
                      @enderror
                       ...
                       <div class="col-sm-12">
                           <label for="email" class="form-label">{{ __('Email') }}</label>
                               ...
                               <input id="email"  placeholder="{{ __('Enter Email') }}" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email" wire:model.debounce.500ms="email">
                       ...
                       <div class="col-sm-3">
                           <label for="woreda" class="form-label">{{ __('Woreda') }}</label>
                               ...
                               <input id="woreda" type="text" class="form-control @error('woreda') is-invalid @enderror" name="woreda" placeholder="{{ __('Enter woreda')}}" autocomplete="woreda" autofocus wire:model.debounce.500ms="woreda">
                       ...
                       <label for="Nationality" class="form-label">{{ __('Nationality') }}</label>
                        ...
                        <div class="col-sm-4">    
                           <label for="role" class="form-label">{{ __('Role') }}</label>
                                  ...
                                  <select class="form-control" id="role" name="role" focus wire:model.debounce.500ms="role">
                        ...
                        <div class="col-sm-4">
                           <label for="password" class="form-label">{{ __('Password') }}</label>
                               ...
                               <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="current-password" wire:model.debounce.500ms="password">
                       ...
                       <div class="col-sm-4">
                           <label for="password-confirm" class="form-label">{{ __('Confirm Password') }}</label>
                               ...
                               <input id="password-confirm" type="password" class="form-control" name="password_confirmation" autocomplete="new-password" wire:model.debounce.500ms="password_confirmation">
                       </div>
