...
<div wire:ignore.self class="modal fade" id="editUser" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
              ...
              @enderror
                ...
                <div class="col-sm-4">    
                    <label for="role" class="form-label">{{ __('Role') }}</label>
                           ...
                           <select class="form-control" id="role" name="role" focus required wire:model.debounce.500ms="role">
