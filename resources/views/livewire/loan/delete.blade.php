{{-- start of delete loan modal --}}

<div wire:ignore.self class="modal fade" id="deleteLoan" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
    aria-hidden="true">
